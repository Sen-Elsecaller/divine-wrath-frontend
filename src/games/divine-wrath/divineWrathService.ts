import { Client as DivineWrathClient, type Game } from './bindings';
...
/**
 * Service for interacting with the DivineWrath game contract
 */
export class DivineWrathService {
  ...
  private createSigningClient(
    ...
    return new DivineWrathClient(options);
  }
  ...
  async prepareStartGame(
    ...
    const buildClient = new DivineWrathClient({
      contractId: this.contractId,
      networkPassphrase: NETWORK_PASSPHRASE,
      rpcUrl: RPC_URL,
...
// Example: const divineWrathService = new DivineWrathService(contractId);
